...
num_epochs = 1
num_class = 2
validname = 'epoch 550 inception renset v2 crossvalid1 cancer'
gpu = 3
...
if __name__ == '__main__':
    ...
    if select:
        ...
        check_dir = 'crossvalid two class train/0'
        net_path = 'normal to tumor heatmap/InceptionResNetV2params_Adamepochs550.pkl'
    ...
    my_model.load_state_dict(torch.load(net_path, map_location='cuda:' + gpu.__str__()))
    oneNET_judge = []
    ...
    oneNETdata_tumor.to_csv(check_dir + '0_' + 'oneNET550' + core_lzj.get_time() + '_acc_result.csv', header=False, index=False)
